...
public class Main {
    public static void main(String[] args) {
        Circle circle = new Circle(3.75); // Object creation of Circle class providing values
        ...
        System.out.println("cylinder.volume= " + cylinder.getVolume());//printing volume values
    }
}
